// src/pages/TX1/TX1StockingTableScan.jsx
...
const TX1StockingTableScan = () => {
  ...
  return (
    <Box sx={{ bgcolor: '#088808', color: '#fff', p: 1 }}>
      ...
      <Button variant="contained" color="inherit" onClick={() => navigate('/TX1/HandheldScanner')} sx={{ mt: 2, color: '#000000' }}>
        Normal Mode
      </Button>
...
export default TX1StockingTableScan;
