...
const TX1ScanSummary = () => {
  const MillOrders = [
    {
      frpid: 116503, status: 'Rolling', id1: '110006972920', id2: '110006972901',
      product: '1REBAR 04-60', grade: 'A615 Gr 60/M31', diameter: '6.25"', length: `37'7"`,
      scheduled: 41, scanned: 41, toScan: 0, toRoll: 30, selected: true
    },
    {
      frpid: 116504, status: '', id1: '110006972820', id2: '110006972801',
      product: '1REBAR 04-60', grade: 'A615 Gr 60/M31', diameter: '6.25"', length: `37'7"`,
    ...
    {
      frpid: 116506, status: '', id1: '110006972620', id2: '110006972601',
      product: '1REBAR 04-60', grade: 'A615 Gr 60/M31', diameter: '6.25"', length: `37'7"`,
      ...
      <Box sx={{ p: 2 }}>
        ...
        <Grid sx={{
          ...
          {MillOrders.map((order) => (
            <Grid sx={{ justifyContent: 'left', mb: 2 }}
              key={order.frpid}>
              <MillOrderCard {...order} />
            </Grid>
          ))}
